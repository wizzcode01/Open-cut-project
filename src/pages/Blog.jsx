          ...
          <div className='max-w-5xl w-full px-4'>
            ...
            className='w-full md:w-[38%] md:h-[65%] flex justify-start items-start flex-col gap-4 p-3 bg-gray-900 rounded-2xl cursor-pointer m-20'>
              ...
              <div className='flex flex-col gap-2'>
                <h1 className='text-[22px] font-semibold'>The OpenCut Alpha is here!</h1>
                <p className='text-sm md:text-lg text-gray-400'>The moment we've all been waiting for - you can finally try OpenCut!</p>
              </div>
           </div>
          </div>
        </div>
